...
from auth_router import router as authRouter  # 新增  
from database import create_tables  # 新增  
...
app.include_router(authRouter, prefix=GLOABLE_PREFIX, tags=["AUTH"])  # 新增认证路由
